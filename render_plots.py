...
#render_plot("gas", sectional_view = True, mappable_for_cbar = None)
render_plot("dust1", sectional_view = True, mappable_for_cbar = None)
#render_plot("dust2", sectional_view = True, mappable_for_cbar = None)